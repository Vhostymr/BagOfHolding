...
public class CharacterDetailsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (cm != null) {
            ...
            intelligenceModifierTV.setText(String.valueOf(
                    Utilities.getAbilityModifier(
                            cm.getStats().getIntelligence()
                    )));
            intelligenceTV.setText(String.valueOf(
                    cm.getStats().getIntelligence()
            ));
            ...
            dexterityTV.setText(String.valueOf(
                    cm.getStats().getDexterity()
            ));
            ...
            wisdomModifierTV.setText(String.valueOf(
                    Utilities.getAbilityModifier(
                            cm.getStats().getWisdom()
                    )));
            wisdomTV.setText(String.valueOf(
                    cm.getStats().getWisdom()
            ));
            ...
            constitutionTV.setText(String.valueOf(
                    cm.getStats().getConstitution()
            ));
            ...
            charismaModifierTV.setText(String.valueOf(
                    Utilities.getAbilityModifier(
                            cm.getStats().getCharisma()
                    )));
            charismaTV.setText(String.valueOf(
                    cm.getStats().getCharisma()
            ));
            ...
            armorClassTV.setText(String.valueOf(
                    cm.getSecondaryStats().getArmorClass()
            ));
            initiativeTV.setText(String.valueOf(
                    cm.getSecondaryStats().getInitiative()
            ));
            speedTV.setText(String.valueOf(
                    cm.getSecondaryStats().getSpeed()
            ));
            maxHitPointsTV.setText(String.valueOf(
                    cm.getSecondaryStats().getMaxHP()
            ));
            temporaryHitPointsTV.setText(String.valueOf(
                    cm.getSecondaryStats().getTempHP()
            ));
        }
        return view;
    }
